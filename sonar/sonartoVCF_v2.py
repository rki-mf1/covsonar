...
def divide_merge_vcf(list_track_vcf, global_output, num_cores):
    '''
    1. Divide the list of vcf files into chunks of 500 files.
        2. Merge the chunks of vcf files into a single vcf file.
        3. Repeat step 2 until all vcf files are merged into a single vcf file.
        4. bgzip and tabix index the final vcf file.
    
    :param list_track_vcf: list of vcf files to merge
    :param global_output: the final output file
